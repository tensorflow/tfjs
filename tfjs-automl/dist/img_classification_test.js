...
const DAISY_URL = 'https://storage.googleapis.com/tfjs-testing/tfjs-automl/img_classification/daisy.jpg';
describeWithFlags('image classification', {}, () => {
    ...
    it('can access the underlying graph model', () => {
        ...
        const scores = model.graphModel.predict(img);
...
//# sourceMappingURL=img_classification_test.js.map