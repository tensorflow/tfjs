...
//               getParamValue('replaceGlobal', node, tensorMap, context) as
//                   boolean,
//               )];
//         }
//         case 'StringNGrams': {
...
//               getParamValue('dataSplits', node, tensorMap, context) as
//               Tensor, getParamValue('separator', node, tensorMap, context) as
//               string, getParamValue('nGramWidths', node, tensorMap, context)
//               as
//                   number[],
...
//               getParamValue('skipEmpty', node, tensorMap, context) as
//               boolean);
...
//               getParamValue('input', node, tensorMap, context) as Tensor,
//               getParamValue('numBuckets', node, tensorMap, context) as
//               number);
//           return [output];
//         }
//         default:
