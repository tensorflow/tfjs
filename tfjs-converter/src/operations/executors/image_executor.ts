...
// import {Tensor, Tensor1D, Tensor2D, Tensor3D, Tensor4D} from
...
//               images as Tensor3D | Tensor4D, [size[0], size[1]],
...
//           const cropSize =
//               getParamValue('cropSize', node, tensorMap, context) as
//               number[];
//           const method =
...
//               getParamValue('images', node, tensorMap, context) as Tensor;
//           const transforms =
//               getParamValue('transforms', node, tensorMap, context) as
//               Tensor;
//           const outputShape =
...
//               fillMode.toLowerCase() as 'constant' | 'reflect' | 'wrap' |
//               'nearest', fillValue, outputShape as [number, number])];
//         }
//         default:
