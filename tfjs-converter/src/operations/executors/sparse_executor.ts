...
//                   Tensor1D, getParamValue('denseShape', node, tensorMap,
//                   context) as
//                       Tensor1D,
...
//                   Tensor2D,
//               getParamValue('inputShape', node, tensorMap, context) as
//               Tensor1D, getParamValue('newShape', node, tensorMap, context)
//               as Tensor1D);
