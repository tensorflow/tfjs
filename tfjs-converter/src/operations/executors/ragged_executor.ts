...
//                       Tensor[],
//                   getParamValue(
//                       'paramsDenseValues', node, tensorMap, context) as
//                       Tensor,
//                   getParamValue('indices', node, tensorMap, context) as
//                   Tensor, getParamValue('outputRaggedRank', node, tensorMap,
//                   context) as
//                       number);
...
//               Tensor, getParamValue('rowPartitionTensors', node, tensorMap,
//               context) as
//                   Tensor[],
