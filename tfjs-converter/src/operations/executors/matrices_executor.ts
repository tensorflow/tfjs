...
//               getParamValue('transposeA', node, tensorMap, context) as
//               boolean, getParamValue('transposeB', node, tensorMap, context)
//               as
//                   boolean)];
...
//               (getParamValue('fusedOps', node, tensorMap, context) as
//               string[]);
...
//               throw new Error(
//                   'Fused MatMul with BiasAdd must have one extra argument:
//                   bias.');
//             }
//           }
...
//               getParamValue('numUpper', node, tensorMap, context) as
//               Scalar)];
