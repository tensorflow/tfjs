...
//         }
//         case 'Gather': {
//           const input = getParamValue('x', node, tensorMap, context) as
...
//           }
//           const input = getParamValue('x', node, tensorMap, context) as
//           Tensor; return [ops.reverse(input, axis)];
//         }
//         case 'ReverseV2': {
//           const axis =
//               getParamValue('axis', node, tensorMap, context) as number[];
...
//           const begin = getParamValue('begin', node, tensorMap, context) as
//           any;
//           // tslint:disable-next-line:no-any
//           const size = getParamValue('size', node, tensorMap, context) as
//           any; return [ops.slice(
...
//           const ellipsisMask =
//               getParamValue('ellipsisMask', node, tensorMap, context) as
//               number;
//           const newAxisMask =
//               getParamValue('newAxisMask', node, tensorMap, context) as
//               number;
//           const shrinkAxisMask =
//               getParamValue('shrinkAxisMask', node, tensorMap, context) as
//               number;
//           const tensor = getParamValue('x', node, tensorMap, context) as
//           Tensor;
...
//               if (!sameShape &&
//                   !util.arraysEqual(ops.squeeze(tensor).shape,
//                   squeezedShape)) {
