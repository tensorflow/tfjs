...
- [High School Level Tensorflowjs](http://rocksetta.com/tensorflowjs/) - Greater than 40 demos that can be online edited made as simply as possible using single web pages. All examples use the <script src="https://cdn.jsdelivr.net/npm/@tensorflow"> specific version tag so the pages always work and no installation is needed - By Jeremy Ellis.
