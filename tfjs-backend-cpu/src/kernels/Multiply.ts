...
const multiplyImpl =
    createBinaryKernelImpl((aValue, bValue) => aValue * bValue);
...
export const multiply = createBinaryKernelComplexSupportKernelFunc(
    Multiply, multiplyImpl, multiplyComplexImpl);
