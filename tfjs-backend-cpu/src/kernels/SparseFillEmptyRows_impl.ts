 ...
 */
 ...
 export function sparseFillEmptyRowsImpl(
   ...
   if (denseRows == 0) {
     ...
     const outputIndices = util.getArrayFromDType(indicesDType, 0 * rank) as TypedArray;
   ...
   if (allRowsFull && rowsAreOrdered) {
     ...
     return [outputIndices, [N, rank], outputValues, emptyRowIndicator, reverseIndexMap];
   } else {
     const NFull = csrOffset[denseRows - 1];
     const outputIndices = util.getArrayFromDType(indicesDType, NFull * rank) as TypedArray;
