...
describe('max_pool_gpu', () => {
  ...
  function compareToCPU(
      xShape: [number, number, number], fSize: [number, number], stride: number,
      pad: number) {
