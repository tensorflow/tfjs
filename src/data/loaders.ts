...
/**
 * Load the model topology file and build the in memory graph of the model.
...
/**
 * Load the model weight file into memory.
 * @param url for the model file generated by the convert.py script.
 */
...
/**
 * Build the map for all weights using the model topology and weight
 * ArrayBuffer.
 * @param url for the model file generated by the convert.py script.
 */
...
/**
 * Build the deeplearn Tensor for the weight defined by the model.
