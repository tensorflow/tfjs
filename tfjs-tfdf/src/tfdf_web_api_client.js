...
const YggdrasilDecisionForests = require('../wasm2/inference.js');
// var tfdfWebApiClient = require('../wasm/inference.js');
exports.tfweb =
    YggdrasilDecisionForests();  // tfdfWebApiClient.YggdrasilDecisionForests();
// console.log(tfdfWebApiClient);
// tfdfWebApiClient().then(function(m) {
// });
