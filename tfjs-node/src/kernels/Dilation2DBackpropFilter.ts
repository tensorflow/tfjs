...
import {backend_util, Dilation2DAttrs, Dilation2DBackpropFilter, Dilation2DBackpropFilterInputs, KernelConfig, registerKernel} from '@tensorflow/tfjs';
...
registerKernel(dilation2dBackpropFilterConfig);
