...
async function main() {
  ...
  console.log(
      `Done. FYI, this script does not publish to NPM. Please publish by ` +
      `running YARN_REGISTRY="https://registry.npmjs.org/" yarn publish-npm ` +
      `at the root after you merge the PR.` +
