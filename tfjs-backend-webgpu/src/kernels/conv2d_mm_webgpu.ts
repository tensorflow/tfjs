...
export class Conv2DMMProgram implements WebGPUProgram {
  ...
  uniformsWgsl =
      `filterDims : vec2<i32>; pad : vec2<i32>; stride : vec2<i32>; dilation : vec2<i32>; dimAOuter : u32; dimBOuter : u32; dimInner : u32;`;
  ...
  getUserCodeWgsl(): string {
    ...
    let WRow = col / (u32(uniforms.filterDims[1]) * uniforms.xShape[3]);
    let WCol = (col / uniforms.xShape[3]) % u32(uniforms.filterDims[1]);
