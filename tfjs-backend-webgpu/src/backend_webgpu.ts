...
import { sumOutType, computeOutAndReduceShapes, assertAxesAreInnerMostDims, computeOptimalWindowSize } from './reduce_util';
...
export class WebGPUBackend extends KernelBackend {
  ...
  max(x: Tensor, axes: number[]): Tensor {
    ...
    const [outShape, reduceShape] =
      computeOutAndReduceShapes(x.shape, axes);
