...
import {DepthwiseConv2DNaiveProgram} from './kernels/depthwise_conv2d_naive_webgpu';
...
export class WebGPUBackend extends KernelBackend {
  ...
  depthwiseConv2D(
    ...
    let program: DepthwiseConv2DNaiveProgram;
    program = new DepthwiseConv2DNaiveProgram(convInfo);
