...
import {BatchMatMul, BatchMatMulAttrs, BatchMatMulInputs, KernelConfig, KernelFunc, upcastType, util} from '@tensorflow/tfjs-core';
...
export function batchMatMul(args: {
  ...
  const out = backend.runWebGLProgram(program, [a3d, b3d], dtype);
