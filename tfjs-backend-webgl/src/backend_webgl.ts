...
import {ceilImplCPU, expImplCPU, expm1ImplCPU, floorImplCPU, greaterImplCPU, lessImplCPU, logImplCPU, negateImplCPU, prodImplCPU, rsqrtImplCPU, simpleAbsImplCPU} from './kernel_utils/shared';
