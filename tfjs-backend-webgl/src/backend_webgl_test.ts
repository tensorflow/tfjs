...
describeWithFlags('lazy packing and unpacking', WEBGL_ENVS, () => {
  ...
  fit('2D array with keep dim', async () => {
    const a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
  ...
  fit('axis=0 in 2D array, keepDims', async () => {
    const a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
  ...
  fit('2D, axis=1 provided as number', async () => {
  ...
  fit('axis=0,1 in 2D array', async () => {
    const a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
  ...
  fit('gradient with clones', async () => {
    const a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
    const dy = tf.scalar(1.5);
  ...
  fit('gradients throws for defined axis', () => {
    const a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
    const dy = tf.scalar(1.5);
  ...
  fit('throws when passed a non-tensor', () => {
  ...
  fit('throws error for string tensor', () => {
    expect(() => tf.mean(['a']))
