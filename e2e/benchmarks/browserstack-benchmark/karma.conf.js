...
function getBrowserStackConfig() {
  const browserstackConfig = {
    ...
    browserStack: {
      ...
      tunnelIdentifier: `e2e_browserstack_benchmark_${Date.now()}_${Math.floor(Math.random() * 1000)}`
    },
    customLaunchers: {},
    browsers: []
  };
...
module.exports = function (config) {
  ...
  config.set({
    ...
    singleRun: true,
    captureTimeout: 3e7,
    reportSlowerThan: 5000000,
    browserNoActivityTimeout: 1.2e7,
    browserDisconnectTimeout: 1.2e7,
    browserDisconnectTolerance: 0,
    browserSocketTimeout: 1.2e7,
