  ...
  async function init() {
      ...
      return new Promise((resolve, reject) => {
          ...
          if (threadsSupported && simdSupported) {
              ...
              wasm = tfjsBackendWasmSimd(factoryConfig);
          }
          else {
