...
_tmp_dir = os.path.join(curr_dir, 'test_data')

def _loadPredictAndSave(model_path):
...
def main():
  _loadPredictAndSave('mlp')
  _loadPredictAndSave('cnn')
  _loadPredictAndSave('depthwise_cnn')
  _loadPredictAndSave('simple_rnn')
  _loadPredictAndSave('gru')
  _loadPredictAndSave('bidirectional_lstm')
  _loadPredictAndSave('time_distributed_lstm')
  _loadPredictAndSave('one_dimensional')
  _loadPredictAndSave('functional_merge')
