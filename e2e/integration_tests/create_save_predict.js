...
async function exportMLSModelV3(exportPath) {
  const model = tfl.sequential();

  model.add(tfl.layers.dense({ units: 100, inputShape: [200], activation: 'relu' }));
...
(async function () {
  // await exportMLSModelV3(join(testDataDir, 'mls'));
