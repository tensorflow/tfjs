...
// #include "src/cc/conv2d.h"
// #include "src/cc/util.h"

// namespace {
// // These integer values are keys to creating the conv2d operator. We use
// // std::array instead of a vanilla array as it implements the compare
// operator
// // needed for std::map.
// typedef std::array<int, 15> OperatorCacheKey;

// // The operator cache maps the cache key to the xnn_operator_t instantiated
// for
...
//             const int input_width, const int filter_id, const int
//             filter_height, const int filter_width, int pad_top, int
//             pad_right, int pad_bottom, int pad_left, const int is_same_pad,
//             const int dilation_height, const int dilation_width, const int
//             stride_height, const int stride_width, const int input_channels,
...
//                                 input_channels, output_channels, filter_id,
//                                 flags};
...
//         pad_top, pad_right, pad_bottom, pad_left, filter_height,
//         filter_width, stride_height, stride_width, dilation_height,
//         dilation_width, groups, input_channels /* group_input_channels */,
...
//       util::warn(
//           "XNN status for xnn_create_convolution2d_nhwc_f32 is not
...
//       filter_operator_cache_key_map.emplace(filter_id,
//       std::move(cache_keys)); backend::register_disposal_callback(filter_id,
//       *delete_xnn_operators);
