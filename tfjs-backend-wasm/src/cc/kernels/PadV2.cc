...
// // Optimized transpose 2D that uses direct pointer arithmetic instead of
// bracket
// // indexing.
// template <typename T>
...
//   // dimensions.
//   const int non_flatten_size = flatten(x_shape, perm, &new_x_shape,
//   &new_perm); const int total_size = tfjs::util::size_from_shape(x_shape);
//   for (int offset = 0; offset < total_size; offset += non_flatten_size) {
//     transpose_impl(x_data + offset, new_x_shape, new_perm, out_data +
//     offset);
//   }
// }
...
//            const DType dtype, const int* paddings_ptr, const int
//            constant_value, const int out_id) {
//   // auto x_shape = std::vector<int>(x_shape_ptr, x_shape_ptr +
//   x_shape_length);
...
//   // switch (dtype) {
//   //   case DType::float32:
//   //     pad<float>(reinterpret_cast<const float*>(x_info.memory_offset),
//   //     x_shape,
//   //                paddings, constant_value,
//   //                reinterpret_cast<float*>(out_info.memory_offset));
//   //     break;
//   //   case DType::int32:
//   //     pad<int>(reinterpret_cast<const int*>(x_info.memory_offset),
//   x_shape,
//   //              perm, reinterpret_cast<int*>(out_info.memory_offset));
//   //     break;
//   //   case DType::boolean:
//   //     pad<bool>(reinterpret_cast<const bool*>(x_info.memory_offset),
//   x_shape,
//   //               perm, reinterpret_cast<bool*>(out_info.memory_offset));
//   //     break;
//   //   default:
//   //     util::warn("Transpose for tensor id %d failed. Unknown dtype %d",
//   x_id,
//   //                dtype);
//   // }
// }
