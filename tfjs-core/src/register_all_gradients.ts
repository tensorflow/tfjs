...
const gradConfigs: GradConfig[] = [
  addGradConfig, addNGradConfig, broadcastToGradConfig, conv2DGradConfig,
  conv2DBackpropInputGradConfig, conv3DGradConfig,
  depthwiseConv2dNativeGradConfig, divGradConfig, fusedBatchNormGradConfig,
