...
import {gatherGradConfig} from './gradients/Gather_grad';
...
const gradConfigs: GradConfig[] = [
  ...
  fusedBatchNormGradConfig, gatherGradConfig, identityGradConfig,
  oneHotGradConfig, padV2GradConfig, squareGradConfig,
