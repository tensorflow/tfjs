...
/**
 * Type for representing a buffer data to create a tensor. Default GPUBuffer
 * usage is GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC. When zeroCopy is
 * false or undefined (default), this GPUBuffer will be copied to the tensor's
 ...
 * access is done. If not specified at creating a tensor, tensor type is
 * float32.
 */
