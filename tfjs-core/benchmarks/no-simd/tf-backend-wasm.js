...
(function (global, factory) {
  ...
  async function init() {
      ...
      const factoryConfig = {};
          ...
          let wasm = await tfjsBackendWasm(factoryConfig);
          console.log("got the backend");
          console.log(wasm);
