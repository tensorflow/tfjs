...
(function (global, factory) {
...
}(this, (function (exports, tfjsCore, path, fs, worker_threads, perf_hooks) {
  'use strict';
  ...
  function registerBinaryKernel(kernelName, supportsFullBroadcast, dtype) {
    ...
    function kernelFunc(args) {
      ...
      var loopsOverAllOfA = aBroadcastDims.every(function (v, i) {
        return v === i;
      });
      var loopsOverAllOfB = bBroadcastDims.every(function (v, i) {
        return v === i;
      });
  ...
  function gatherNd(args) {
    ...
    var x = inputs.x,
      indices = inputs.indices;
    var _a = tfjsCore.gather_util.prepareAndValidate(x, indices),
      resultShape = _a[0],
      numSlices = _a[1],
      sliceSize = _a[2],
      strides = _a[3];
  ...
  function max(args) {
    ...
    var _a = tfjsCore.backend_util.computeOutAndReduceShapes(x.shape, axes),
      outShape = _a[0],
      reduceShape = _a[1];
  ...
  function resizeBilinear(args) {
    ...
    var alignCorners = attrs.alignCorners,
      newHeight = attrs.newHeight,
      newWidth = attrs.newWidth;
    var _a = x.shape,
      batch = _a[0],
      oldHeight = _a[1],
      oldWidth = _a[2],
  ...
  function transpose(args) {
    ...
    var _a = removeOneSizeDims(inputs.x.shape, attrs.perm),
      reducedShape = _a[0],
      perm = _a[1];
    var x = {
      ...
      return (
        function (WasmBackendModule) {
          ...
          if (ENVIRONMENT_IS_NODE) {
            ...
            try {
              nodeWorkerThreads = worker_threads;
            } catch (e) {
