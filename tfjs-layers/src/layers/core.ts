...
// TODO : Replace ../../../tfjs-core/src with @tensorflow-js/core once all is stable and agreed.
import { any, cast, mul, notEqual, reshape, serialization, Tensor, tidy, transpose, util, matMul, sqrt, scalar, softmax, dropout, leakyRelu } from '../../../tfjs-core/src';
import { LayerNormalization } from "../layers/normalization";
...
class TransformerLayer extends Layer
{
  ...
  ): Tensor | Tensor[]
  {
    return tidy(() =>
    {
      ...
      const normalizedLatent = new LayerNormalization()
